...
tmux set-hook -g "after-new-window[207]" "run-shell -b '$CURRENT_DIR/scripts/ensure-sidebar-pane.sh'"
tmux set-hook -g "after-kill-pane[208]" "run-shell -b '$CURRENT_DIR/scripts/handle-pane-exited.sh #{hook_pane} #{hook_window}'"
tmux set-hook -g "after-resize-pane[209]" "run-shell -b '$CURRENT_DIR/scripts/notify-sidebar.sh'"
tmux set-hook -g "after-rename-window[210]" "run-shell -b '$CURRENT_DIR/scripts/notify-sidebar.sh'"
